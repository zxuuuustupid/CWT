data=xlsread("D:\science\PHM\PHM比赛数据集\Data_Pre Stage\Data_Final_Stage\Training\M0_G3_LA1_RA0\Sample_1\data_motor.csv");
data=data(:,6)
name='TYPE713_motor_CH6'
path='CWT-1000\motor\test\anomaly\anomalyTYPE713\anomaly'
data=data(1:4096)
